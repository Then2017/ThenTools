...
public class EditToolsUI extends JPanel {
	...
	public EditToolsUI() {
	      ...
	      lblEditTools.setFont(new Font("微软雅黑", Font.BOLD, 12));
...
//								,JOptionPane.INFORMATION_MESSAGE); 
		      ...
		      //字体选择
			   ...
			   lblCoordinate.setFont(new Font("微软雅黑", Font.PLAIN, 12));
			   ...
			   lblDrawinfo.setFont(new Font("微软雅黑", Font.PLAIN, 12));
	...
	public String getString(String flag){
		...
		case "tiptext": 
			if(com.Main.ThenToolsRun.Language.equals("CN")){
			return "新建一个图片,打开图片,保存图片,画笔,直线,矩形,实心矩形,椭圆,实心椭圆,圆,实心圆,圆角矩形,实心圆角矩形,橡皮擦,颜色,选择线条的粗细,文字,撤销";
		}else{
		...
		case "lblDrawinfo1": 
			if(com.Main.ThenToolsRun.Language.equals("CN")){
			return tiptext[tiptextnum]+",粗细="+(int)(Float.parseFloat(screenshotui.getStroke()))+
