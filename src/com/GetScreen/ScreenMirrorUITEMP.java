...
public class ScreenMirrorUITEMP extends JFrame {
...
//	  };
	  ...
	  public ScreenMirrorUITEMP(String[] args)
	  {
	    initializeall(args);
	 ...
	 //   addWindowListener(this.mWindowListener);
	  ...
	  private void initializeSelectDeviceMenu() {
	    ...
	    menuItemSelectDevice.addActionListener(new ActionListener() {
	      public void actionPerformed(ActionEvent e) {
	        ScreenMirrorUITEMP.this.selectDevice();
	      }
	    });
	  ...
	  private void initializeOrientationMenu() {
	    ...
	    radioButtonMenuItemPortrait.addActionListener(new ActionListener() {
	      public void actionPerformed(ActionEvent e) {
	        ScreenMirrorUITEMP.this.setOrientation(true);
	      }
	    });
	    ...
	    radioButtonMenuItemLandscape.addActionListener(new ActionListener() {
	      public void actionPerformed(ActionEvent e) {
	        ScreenMirrorUITEMP.this.setOrientation(false);
	      }
	    });
	  ...
	  private void initializeZoomMenu() {
	    ...
	    radioButtonMenuItemZoom25.addActionListener(new ActionListener() {
	      public void actionPerformed(ActionEvent e) {
	        ScreenMirrorUITEMP.this.setZoom(0.25D);
	      }
	    });
	    ...
	    radioButtonMenuItemZoom50.addActionListener(new ActionListener() {
	      public void actionPerformed(ActionEvent e) {
	        ScreenMirrorUITEMP.this.setZoom(0.5D);
	      }
	    });
	    ...
	    radioButtonMenuItemZoom75.addActionListener(new ActionListener() {
	      public void actionPerformed(ActionEvent e) {
	        ScreenMirrorUITEMP.this.setZoom(0.75D);
	      }
	    });
	    ...
	    radioButtonMenuItemZoom100.addActionListener(new ActionListener() {
	      public void actionPerformed(ActionEvent e) {
	        ScreenMirrorUITEMP.this.setZoom(1.0D);
	      }
	    });
	    ...
	    radioButtonMenuItemZoom150.addActionListener(new ActionListener() {
	      public void actionPerformed(ActionEvent e) {
	        ScreenMirrorUITEMP.this.setZoom(1.5D);
	      }
	    });
	    ...
	    radioButtonMenuItemZoom200.addActionListener(new ActionListener() {
	      public void actionPerformed(ActionEvent e) {
	        ScreenMirrorUITEMP.this.setZoom(2.0D);
	      }
	    });
	      ...
	      public void actionPerformed(ActionEvent e) {
				...
				if(input!=null){
					if(!input.equals("")&&Helper.isDecimal(input)&&Double.parseDouble(input)>=0.1&&Double.parseDouble(input)<=1){
						  ScreenMirrorUITEMP.this.setZoom(Double.parseDouble(input));
	  ...
	  private void initializeAdjustColor() {
	    ...
	    this.mAdjustColorCheckBoxMenuItem.addActionListener(new ActionListener() {
	      public void actionPerformed(ActionEvent e) {
	        ScreenMirrorUITEMP.this.mAdjustColor = (!ScreenMirrorUITEMP.this.mAdjustColor);
	        ScreenMirrorUITEMP.this.mAdjustColorCheckBoxMenuItem.setSelected(ScreenMirrorUITEMP.this.mAdjustColor);
	      }
	    });
	  ...
	  private void initializeSaveImageMenu() {
	    ...
	    menuItemSaveImage.addActionListener(new ActionListener() {
	      public void actionPerformed(ActionEvent e) {
	        ScreenMirrorUITEMP.this.saveImage();
	      }
	    });
...
//	      128), "About ASM");
	  ...
	  public class MainPanel extends JPanel
	  {
	    ...
	    protected void paintComponent(Graphics g)
	    {
	      ...
	      if (ScreenMirrorUITEMP.this.mPortrait) {
	         srcWidth = ScreenMirrorUITEMP.this.mRawImageWidth;
	        srcHeight = ScreenMirrorUITEMP.this.mRawImageHeight;
	      } else {
	        srcWidth = ScreenMirrorUITEMP.this.mRawImageHeight;
	        srcHeight = ScreenMirrorUITEMP.this.mRawImageWidth;
	      }
	      int dstWidth = (int)(srcWidth * ScreenMirrorUITEMP.this.mZoom);
	      int dstHeight = (int)(srcHeight * ScreenMirrorUITEMP.this.mZoom);
	      if (ScreenMirrorUITEMP.this.mZoom == 1.0D) {
	 ...
	 // TODO 鼠标事件MouseA类继承了MouseAdapter 
	    ...
	    class MouseA extends MouseAdapter
	    {
	    	...
	    	public void mouseEntered(MouseEvent me) {
	    		// TODO 鼠标进入
	    			ScreenMirrorUITEMP.this.setTitle("("+(int)(me.getX()/mZoom)+","+(int)(me.getY()/mZoom)+")  "+title);
	    	}
	    	...
	    	public void mouseReleased(MouseEvent me) {
	    		// TODO 鼠标松开
	    		  ScreenMirrorUITEMP.this.mPopupMenu.show(me.getComponent(), me.getX(), me.getY());
	    	}
	    ...
	    private FBImage getDeviceImage() throws IOException {
	      ...
	      if (success)
	      {
	        ...
	        if (rawImage.bpp == 16)
	        {
	          int offset1;
	          int offset0;
	          if (!ScreenMirrorUITEMP.this.mAdjustColor) {
	            offset0 = 0;
	            offset1 = 1;
	          } else {
	            offset0 = 1;
